...
<div class="register">
    ...
    <form id="registerForm" action="${pageContext.request.contextPath}/userRegist" method="post"  onsubmit="return check()">
        ...
        <div class="input">
            <span>用户类别：         </span>
            <input type="radio" name="authority" value="common" checked>普通用户
